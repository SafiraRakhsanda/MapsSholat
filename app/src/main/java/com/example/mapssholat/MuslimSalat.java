...
public class MuslimSalat extends AppCompatActivity {
    ...
    TextView mSubuhTv, mSyuruqTv, mDzuhurTv, mAsharTv, mMaghribTv, mIsyaTv, mLocationTv, mDateTv,textView;
    Button mButtonSrc;
    String mEbi;
    ...
    private void searchLoc() {
        ...
        pDialog.setMessage("Loding Bang SABAAAR");
        pDialog.show();
